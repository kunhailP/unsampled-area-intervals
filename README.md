...
| Exact 2-D reduction of the shrink function; small-noise law and boundary map; heterogeneous-noise kernel; HetLDC (synthetic, apipop) | `e16`, `e18`–`e21` | see `docs/THEORY_NOTE.md`, FINDINGS C29–C34 |
...
experiments/    e01 ... e21, fetch_apipop.py, _common.py
